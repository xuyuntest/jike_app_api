...
req_typy = "GET"
req_data = ""
req_url =  "http://api.jikexueyuan.com/v3/activity/share_third?api_key=uyW3d8Fu&api_sig=d94bd3dfb209852070c0165259f8cd42&from=1-5.0.1-2.4.0&timestamp=20150824175553&nonce=a796ff78&channel=jkxiaomi_pt_sd_1_2.4.0_101&third=2&type=2&cid=119"
req_host = "api.jikexueyuan.com"

#response
expect1 = '200'
expect2 = 'ok'
expect3 = 'iOS用户界面开发基本流程'
