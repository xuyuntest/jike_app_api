...
req_typy = "GET"
req_data = ""
req_url =  "http://api.jikexueyuan.com/v3/course/history_list?debug=eNIgma&nonce=525d5036&from=1-5.0.1-2.4.0&timestamp=20150813104621&api_key=uyW3d8Fu&channel=jkxiaomi_pt_sd_1_2.4.0_101&api_sig=5a71a3e94016c6c7fd0d0a3b3408d93c&uid=3574506&p=1&n=1"
req_host = "api.jikexueyuan.com"

#response
expect1 = '200'
expect2 = 'ok'
expect3 = '"total_pages":192'
